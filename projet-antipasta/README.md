...
- Prénom : Guillaume 
- URL du site : (À venir)
- Url de la maquette : https://www.figma.com/file/hGcN9IRAoyBrk0soY2yg3o/SAE-105-(2022)-LE-TREQUESSER-Guillaume?type=design&node-id=322%3A1210&t=bLqpYzPbrCh3TetC-1
...
- Usage de `<Suspense>` et d'"`await`" pour récupérer les données du backend. (appel de fonction)
...
- [X] Donnez l'adresse IP de votre VPS : 193.168.146.196

- [X] Donnez le login et le mot de passe admin du compte pocketbase : guillaume.letrequesser@gmail.com Gletrequess59!

- [X] Donnez l'URL du backend `http://.../_/` (IP ou dommaine) : http://193.168.146.196/_/

- [X] Donnez l'URL du frontend `http://.../` (IP ou domaine) : http://sae203.guillaume-le-trequesser.fr

- [X] Donnez l'URL HTTP**S** du frontend `https://foo.bar/` (nom de domaine) : https://sae203.guillaume-le-trequesser.fr
